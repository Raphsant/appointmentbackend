...
db.insurance = require("../models/insurance.model")(sequelize, Sequelize)
...
db.insurance.hasMany(db.user, { foreignKey: 'insuranceId' });
db.user.belongsTo(db.insurance, { foreignKey: 'insuranceId' });
